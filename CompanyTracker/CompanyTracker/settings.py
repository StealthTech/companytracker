...
PROJECT_CONF = Configuration.compile_from_presets(os.path.join(PROJECT_ROOT, 'conf/project.conf'), [
    ProjectPreset(name='CompanyTracker', version='0.0.1', site_url='http://localhost:8000'),
    OptionsPreset(secret_key=None, debug=False, allowed_hosts=['127.0.0.1'], database='posrgresql', cache='redis'),
])
...
ROOT_URLCONF = 'CompanyTracker.urls'
...
WSGI_APPLICATION = 'CompanyTracker.wsgi.application'
